...
<table class="adst-form-table" >
	<br>
		<tr class="wpas-frequency">
			<th scope="row">
				<label for="UpdateFrequency"><?php esc_html_e( 'Update Stats After', 'wp-themes-plugins-stats' ); ?></label>
			</th>
			<td class="adst-frequency-input">
					...
					<label><?php esc_html_e( 'Day(s)', 'wp-themes-plugins-stats' ); ?></label>
			</td>
		</tr>
		<tr class="adst-description">
			...
			<td class="adst-description" colspan="3">
				<p class="description adst-description">
					<?php esc_html_e( 'Set how frequently you want to update the stats data from WordPress API. This setting is helpful to reduce API calls.', 'wp-themes-plugins-stats' ); ?>
				</p>
			</td>
		</tr>
		<tr class="wpas-hrformat">
			<th scope="row">
				<label for="hrformat"><?php esc_html_e( 'Installation & Download Count Format', 'wp-themes-plugins-stats' ); ?></label>
			</th>
			<td class="adst-hroption">
				<div id="hr_option" class="adst-hr-option">
					...
					<?php esc_html_e( 'Default (1000000)', 'wp-themes-plugins-stats' ); ?>
					</label>
					<br>
					<label>
					<input type="radio" name="adst_r_option" id="thousand"  value="K"  <?php checked( 'K' === $adst_rchoice ); ?> />
					<?php esc_html_e( 'In Thousands (1000K)', 'wp-themes-plugins-stats' ); ?>
					...
					<?php esc_html_e( 'In Millions (1M)', 'wp-themes-plugins-stats' ); ?>
						<input type="text"  class="small-text adst-small-text2"  name="field2" placeholder="M" value="<?php echo esc_attr( $adst_field2 ); ?>"  />
					</label>
					<p class="description adst-description">
					<?php esc_html_e( 'Generally, installation & download count is a big number. You can display it in a more readable format.', 'wp-themes-plugins-stats' ); ?><br><?php esc_html_e( 'For Example, A number 1,000,000 can be displayed as 1M or 1000K.', 'wp-themes-plugins-stats' ); ?>
					</p>
				</div>
			</td>
		</tr>
		...
		<tr id="title_num_option" <?php echo wp_kses_post( $adst_numchoice_disp ); ?>>
			<th class="adst-num-option"><?php esc_html_e( 'Number Grouping Format', 'wp-themes-plugins-stats' ); ?></th>
		...
		<tr>
			<th scope="row"><label><?php esc_html_e( 'Date Format', 'wp-themes-plugins-stats' ); ?></label></th>
				<td class="adst-date">
					<fieldset class="adst-date">
					<?php
						$adst_date_formats = array_unique( apply_filters( 'adst_date_formats', array( __( 'F j, Y', 'wp-themes-plugins-stats' ), 'Y-m-d', 'm/d/Y', 'd/m/Y' ) ) );//PHPCS:ignore:WordPress.WP.I18n.MissingArgDomain
						$adst_format       = 'd-m-y';
						$adst_custom       = true;
					foreach ( $adst_date_formats as $adst_format ) {
						...
						echo '<p class="description adst-description"><a href="https://wordpress.org/support/article/formatting-date-and-time/">' . wp_kses_post( ' Refer article on date formatting', 'wp-themes-plugins-stats' ) . '</a></p>';
					?>
					</fieldset>
				</td>
		</tr>
