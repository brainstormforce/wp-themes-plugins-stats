...
?>
	<div class="wp-as-global-settings">
	...
	<br><label class="wp-as-page-title" for="howtouse"></label>
		<h2>
		<?php
...
<div class="wp-as-resp-table">
				<div class="wp-as-resp-table-caption"><?php esc_attr_e( 'THEME SHORTCODE TABLE', 'wp-as' ); ?></div>
					<div class="wp-as-resp-table-header">
						<div class="wp-as-table-header-cell">
							<?php esc_attr_e( 'Theme Name', 'wp-as' ); ?>
						</div>
						<div class="wp-as-table-body-cell">
				...
				<div class="wp-as-resp-table">
				<div class="wp-as-resp-table-caption"><?php esc_attr_e( 'PLUGIN SHORTCODE TABLE', 'wp-as' ); ?></div>
					<div class="wp-as-resp-table-header">
						<div class="wp-as-table-header-cell">
