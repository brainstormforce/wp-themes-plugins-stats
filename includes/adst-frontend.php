...
esc_attr_e( 'WP Themes & Plugins Stats', 'wp-themes-plugins-stats' );
echo '</h1>';
...
<a href="?page=bsf-as-setting-admin&tab=wp_as_general_settings" class="nav-tab tb 
	...
	?>
	"><?php esc_attr_e( 'General', 'wp-themes-plugins-stats' ); ?></a>
		...
		?>
		"><?php esc_attr_e( 'Shortcodes', 'wp-themes-plugins-stats' ); ?></a>
</h2>
